        ...
        return (
            <Navbar bg="transparent" className="border-bottom" style={{ height: "2.5em", fontSize: "1em" }}>
                ...
                <Container style={{ justifyContent: "flex-end", gap: "2em" }} >
                    <Nav.Link style={NavLinkCSS} href={ process.env.PUBLIC_URL + "/personal-portfolio/"} > Home </Nav.Link>
                    <Nav.Link style={NavLinkCSS} href={ process.env.PUBLIC_URL + "/personal-portfolio/about" } > About </Nav.Link>
                    <Nav.Link style={NavLinkCSS} href={ process.env.PUBLIC_URL + "/personal-portfolio/projects" } > Projects </Nav.Link>
                </Container>
            </Navbar>
        );
    }
